# R code for the project Charlson Comorbidity Index (CCI) in Heart Failure across the Ejection Fraction spectrum: association with clinical characteristics, EF category, medical therapy and outcomes
